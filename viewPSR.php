                    ...
                    <tbody>
                        <?php
                            while ($row=mysqli_fetch_array($query_get_all_performance)) {
                                ...
                                echo "<tr>
                                        <td><a href='generatepar.php?m=".$messenger_id."' class='btn btn-xs btn-info'><i class='fa fa-pencil-square-o'></i></td>
                                        <td>$messenger_name</td>
                                        <td>$total_1</td>
                                        <td>$total_2</td>
                                        <td>$total_3</td>
                                        <td><input type='radio' value='$messenger_id'required ></td>
                                    </tr>";
                            }
                        ?>
                    </tbody>
