...
$sql_view="SELECT r.receivedmailID, u.firstname, u.lastname, m.mailtypeName, r.quantity, r.dueDate
            ...
            INNER JOIN mailtypes m on m.mailtypeID=r.mailtypeID WHERE r.status='Active'";
...
<div class="container">
    <div class="col-lg-12">
        <h1 class="text-center"><i class="fa fa-list"></i> View Received Mails</h1>
        <form class="form-horizontal well">
           <table id="posts" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                <tr>

                    <th>Receive Mail ID</th>
                    <th>Employee Name</th>
                    <th>Mail Type</th>
                    <th>Quantity</th>
                    <th>Due Date</th>
                ...
                while ($row = mysqli_fetch_array($result_view))
                {
                    ...
                    echo"
                                <tr>
                                    ...
                                    <td>". $quantity. "</td>
                                    <td>". $dueDate. "</td>
                                    <td><a href='editreceivedmail.php?receivedmailID=". $receivedmailID. "' class='btn btn-xs btn-info'>
                                    <i class='fa fa-pencil-square-o'></i></</td>
                                    <td><a href='archiveReceivedMail.php?receivedmailID=".$receivedmailID."' class='btn btn-xs btn-danger'>                                  
